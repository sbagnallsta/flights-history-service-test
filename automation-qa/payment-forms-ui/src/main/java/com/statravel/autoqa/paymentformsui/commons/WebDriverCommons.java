...
public class WebDriverCommons {
    ...
    public void swithToFrame(final int frameNo) throws InterruptedException {
        ...
        utilities.timeInterval(AutomationConstant.TIME_INTERVAL_FOR_FIVE_SECONDS);
    ...
    public void waitForLoad() {
        ...
        new WebDriverWait(WebDriverFactory.getWebDriver(), 30).until(
                (ExpectedCondition<Boolean>) wd -> ((JavascriptExecutor) wd).executeScript("return document.readyState")
                                                                            .equals("complete"));
    }
