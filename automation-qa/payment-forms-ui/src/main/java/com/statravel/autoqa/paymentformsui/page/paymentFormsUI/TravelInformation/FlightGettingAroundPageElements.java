 ...
 *
 */
public class FlightGettingAroundPageElements extends PageElements {
    @FindBy(css = "#getting-around-heading")
    private WebElement heading;

    @FindBy(css = "#getting-around-flight-number-1")
    private WebElement firstFlightNo;

    @FindBy(css = "#getting-around-flight-number-2")
    private WebElement secondFlightNo;

    @FindBy(css = "#getting-around-departure-date-1")
    private WebElement firstDepartureDate;

    @FindBy(css = "#getting-around-departure-date-2")
    private WebElement secondDepartureDate;

    @FindBy(css = "#getting-around-departure-time-1")
    private WebElement firstDepartureTime;

    @FindBy(css = "#getting-around-departure-time-2")
    private WebElement secondDepartureTime;

    @FindBy(css = "#getting-around-departure-city-1")
    private WebElement firstDepartureCity;

    @FindBy(css = "#getting-around-departure-city-2")
    private WebElement secondDepartureCity;

    @FindBy(css = "#getting-around-departure-airport-1")
    private WebElement firstDepartureAirport;

    @FindBy(css = "#getting-around-departure-airport-2")
    private WebElement secondDepartureAirport;

    @FindBy(css = "#getting-around-departure-airport-code-1")
    private WebElement firstDepartureAirportCode;

    @FindBy(css = "#getting-around-departure-airport-code-2")
    private WebElement secondDepartureAirportCode;

    @FindBy(css = "#getting-around-arrival-date-1")
    private WebElement firstArrivalDate;

    @FindBy(css = "#getting-around-arrival-date-2")
    private WebElement secondArrivalDate;

    @FindBy(css = "#getting-around-arrival-city-1")
    private WebElement firstArrivalCity;

    @FindBy(css = "#getting-around-arrival-city-2")
    private WebElement secondArrivalCity;

    @FindBy(css = "#getting-around-arrival-time-1")
    private WebElement firstArrivalTime;

    @FindBy(css = "#getting-around-arrival-time-2")
    private WebElement secondArrivalTime;

    @FindBy(css = "#getting-around-arrival-airport-1")
    private WebElement firstArrivalAirport;

    @FindBy(css = "#getting-around-arrival-airport-2")
    private WebElement secondArrivalAirport;

    @FindBy(css = "#getting-around-arrival-airport-code-1")
    private WebElement firstArrivalAirportCode;

    @FindBy(css = "#getting-around-arrival-airport-code-2")
    private WebElement secondArrivalAirportCode;

    @FindBy(css = "#getting-around-day-indicator-1")
    private WebElement firstFlightDayIndicator;

    @FindBy(css = "#getting-around-day-indicator-2")
    private WebElement secondFlightDayIndicator;

    @FindBy(css = "#getting-around-flight-airline-operator-1")
    private WebElement firstAirline;

    @FindBy(css = "#getting-around-flight-airline-operator-2")
    private WebElement secondAirline;

    @FindBy(css = "#getting-around-operator-1")
    private WebElement firstAirlineOperator;

    @FindBy(css = "#getting-around-operator-2")
    ...
    public String toString() {
        return "FlightGettingAroundPageElements [heading=" + heading + ", firstFlightNo=" + firstFlightNo + ", secondFlightNo=" + secondFlightNo
