...
public final class FlightSearch implements Serializable {
    ...
    private List<PreferredAirline> preferredAirlineList = new ArrayList<>();
    ...
    public FlightSearch(final int numberOfAdults, final int numberOfStudents, final int numberOfUnder26, final int numberOfTeachers,
            final double cheapestPrice, final boolean flexibleDate, final String cabinClass) {
    ...
    public String toString() {
        return "FlightSeach [numberOfAdults=" + numberOfAdults + ", numberOfStudents=" + numberOfStudents + ", numberOfUnder26=" + numberOfUnder26
                + ", numberOfTeachers=" + numberOfTeachers + ", cheapestPrice=" + cheapestPrice + " flexibleDate=" + flexibleDate + ", cabinClass="
                + cabinClass + ", flightDestinationList=" + flightDestinationList + ", preferredAirlineList=" + preferredAirlineList + "]";
    }
