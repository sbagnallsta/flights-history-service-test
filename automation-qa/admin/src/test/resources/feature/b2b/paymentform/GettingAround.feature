@FlightsGettingAround
Feature: Flight module - Getting Around section - B2B Automation
  As an admin UI user 
  I want to perform some actions on B2B Payment portal Getting Around section
  So that I can manage Getting Around details displayed on payment form

  @GettingAround1
  Scenario: Verify admin user can not add Getting Around flights details without entering flight details
  ...
  @GettingAround3 @Regression @Smoke
  Scenario: Verify admin user can delete a Getting Around flight
    Given I am on Payment Form Details page
    When I add two Getting Around flights
  ...
  @GettingAround4 @Regression @Smoke
  Scenario: Verify admin user can add edit flights in getting Around section
    Given I am on Flights Getting Around page
    Then I should see messages for all require fields
